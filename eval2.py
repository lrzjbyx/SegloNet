...
def predict_all_seal(src_folder,output_folder,weights_path,eval_json_path,eval_dict_path="prediction_align.json"):
    ...
    # create model
    model = u2_hr_backbone(cfg="xx",key_joints=10)
        ...
        with torch.inference_mode():
            ...
            try:
                for i, keypoint in enumerate(keypoints):
                    ...
                    fit_list.append(ann_t)

                plot_region(polys,keypoints, image,file_name)

                predict_dict[file_name] = fit_list
    ...
    print("===================predict dict file======================")
    json_str = json.dumps(predict_dict, indent=4)
    with open(eval_dict_path, 'w') as json_file:
        json_file.write(json_str)
    print("===================predict dict file======================")
...
if __name__ == '__main__':
    ...
    # weights_path = "save_weights/model_123.pth"
    # weights_path = "save_weights/model_86.pth"
    # weights_path = "save_weights/model_cat.pth"
    # weights_path = "save_weights/model_best1.pth"
    # weights_path = "save_weights/model_best2.pth"
    # weights_path = "model_best.pth"
    # weights_path = "save_weights/model_best66.pth"
    # weights_path = "save_weights/model_165.pth"
    # weights_path = "pretrained/model-pretrained-xx.pth"
    # weights_path = "pretrained/model-pretrained-sx.pth"

    load_annotation(r"C:\Users\jackm\Desktop\test_seal","ground_truth.json")
    predict_all_seal(r"C:\Users\jackm\Desktop\test_seal", "sourcell", weights_path, "predictions.json")
